...
@section('subpage__header')
	<div class="Subpage">
		<div class="container Flex Flex--column Flex--center">			
			<h1 class="Subpage__title">Frequently Asked Questions</h1>
...
@section('content')
	<div class="Row Flex--column">
		<h3>How long will it take to be approved and open a new Franchise?</h3>
		<p>
		...
		<h3>How do I know if I am qualified?</h3>
		<p>
		...
		<h3>Are there existing restaurants for sale? What is the process of buying one?</h3>
		<p>
